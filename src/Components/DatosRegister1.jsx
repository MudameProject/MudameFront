...
const DatosRegister = () => {
  ...
  const buttonClass = isButton ? "block" : "hidden";
  ...
  if (!isVisible) {
    return <Link to="/RegisterClient"></Link>;
  }
  ...
  <div className="w-full flex flex-col">
    <div className="w-full flex justify-around">
      ...
      <button
        ...
        className={`${buttonClass} bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition-all ease-in duration-200`}
      >
        Continuar
      </button>
    </div>
