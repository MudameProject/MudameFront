...
//LOGICA PARA PODER CONSUMIR EL BACKEND
  ...
  <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
    ...
    <tbody class="divide-y divide-gray-100 border-t border-gray-100">
        ...
        <th class="flex gap-3 px-6 py-4 font-normal text-gray-900">
          <div class="relative h-10 w-10">
            <img
              ...
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR-0asgmfB0U7vB7zyTQ2nzjucgZ1pbpXSLcaLA3PRcBg&s"
              alt=""
            />
      ...
      <tr class="hover:bg-gray-50">
        ...
        <td class="px-6 py-4">Represent</td>
        <td class="px-6 py-4">
          <div class="flex gap-2">
            <span
              class="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-1 text-xs font-semibold text-blue-600"
...
<div className='w-full flex h-20 justify-center items-center gap-10'>
<span class="inline-flex items-center gap-1 rounded-lg bg-indigo-300 p-3 text-sm font-semibold text-indigo-600">
<Link to="/" class="text-decoration-none">
                Home
              </Link></span>
    <span class="inline-flex items-center gap-1 rounded-md bg-red-300 p-3 text-sm font-semibold text-red-700">
